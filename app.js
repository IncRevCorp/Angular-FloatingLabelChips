...
MyApp.controller('InputDemoCtrl', function CtrlDemo($timeout, $q) {
    var self = this;
    self.readonly = false;
...
var MyCustomApp = angular.module('MyCustomApp', ['ngMaterial'])

MyCustomApp.controller('CustomInputDemoCtrl', function CustomCtrlDemo($timeout, $q) {
    var self = this;
    self.readonly = false;
    self.selectedItem = null;
    self.searchText = null;
